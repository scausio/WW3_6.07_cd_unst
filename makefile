...
$(aPe)/ww3_grid : $(aPo)/yowsidepool.o
$(aPe)/ww3_grid : $(aPo)/yowdatapool.o
$(aPe)/ww3_grid : $(aPo)/yowerr.o
$(aPe)/ww3_grid : $(aPo)/yownodepool.o
$(aPe)/ww3_grid : $(aPo)/yowelementpool.o
$(aPe)/ww3_grid : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_grid : $(aPo)/yowrankModule.o
$(aPe)/ww3_grid : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_grid : $(aPo)/yowpd.o
...
$(aPe)/ww3_grid : $(aPo)/ww3_grid.o
	@$(aPb)/link ww3_grid w3wdatmd w3gdatmd w3adatmd w3idatmd w3odatmd wmmdatmd   w3parall w3triamd w3src4md w3snl1md    w3iogrmd constants w3servmd w3arrymd w3dispmd w3gsrumd w3timemd w3nmlgridmd yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd 
...
$(aPe)/ww3_strt : $(aPo)/yowfunction.o
$(aPe)/ww3_strt : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_strt : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_strt : $(aPo)/yowsidepool.o
$(aPe)/ww3_strt : $(aPo)/yowdatapool.o
$(aPe)/ww3_strt : $(aPo)/yowerr.o
$(aPe)/ww3_strt : $(aPo)/yownodepool.o
$(aPe)/ww3_strt : $(aPo)/yowelementpool.o
$(aPe)/ww3_strt : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_strt : $(aPo)/yowrankModule.o
$(aPe)/ww3_strt : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_strt : $(aPo)/yowpd.o
...
$(aPe)/ww3_strt : $(aPo)/ww3_strt.o
	@$(aPb)/link ww3_strt  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3str1md  w3sbt1md  w3src4md w3snl1md   wmmdatmd w3parall  w3iogrmd w3iorsmd constants w3triamd w3servmd w3arrymd w3dispmd w3gsrumd w3timemd
...
$(aPe)/ww3_prep : $(aPo)/yowfunction.o
$(aPe)/ww3_prep : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_prep : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_prep : $(aPo)/yowsidepool.o
$(aPe)/ww3_prep : $(aPo)/yowdatapool.o
$(aPe)/ww3_prep : $(aPo)/yowerr.o
$(aPe)/ww3_prep : $(aPo)/yownodepool.o
$(aPe)/ww3_prep : $(aPo)/yowelementpool.o
$(aPe)/ww3_prep : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_prep : $(aPo)/yowrankModule.o
$(aPe)/ww3_prep : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_prep : $(aPo)/yowpd.o
...
$(aPe)/ww3_prep : $(aPo)/ww3_prep.o
	@$(aPb)/link ww3_prep  w3gdatmd w3adatmd w3idatmd w3odatmd w3wdatmd wmmdatmd w3fldsmd  yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  w3triamd w3src4md w3snl1md     w3iogrmd     constants w3servmd w3timemd  w3arrymd w3dispmd w3gsrumd w3parall
...
$(aPe)/ww3_prnc : $(aPo)/yowfunction.o
$(aPe)/ww3_prnc : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_prnc : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_prnc : $(aPo)/yowsidepool.o
$(aPe)/ww3_prnc : $(aPo)/yowdatapool.o
$(aPe)/ww3_prnc : $(aPo)/yowerr.o
$(aPe)/ww3_prnc : $(aPo)/yownodepool.o
$(aPe)/ww3_prnc : $(aPo)/yowelementpool.o
$(aPe)/ww3_prnc : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_prnc : $(aPo)/yowrankModule.o
$(aPe)/ww3_prnc : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_prnc : $(aPo)/yowpd.o
...
$(aPe)/ww3_prnc : $(aPo)/ww3_prnc.o
	@$(aPb)/link ww3_prnc  w3gdatmd w3adatmd w3idatmd w3odatmd w3wdatmd wmmdatmd w3fldsmd  yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  w3triamd w3src4md w3snl1md   w3parall  w3iogrmd     constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd  w3nmlprncmd
...
$(aPe)/ww3_shel : $(aPo)/yowsidepool.o
$(aPe)/ww3_shel : $(aPo)/yowdatapool.o
$(aPe)/ww3_shel : $(aPo)/yowerr.o
$(aPe)/ww3_shel : $(aPo)/yownodepool.o
$(aPe)/ww3_shel : $(aPo)/yowelementpool.o
$(aPe)/ww3_shel : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_shel : $(aPo)/yowrankModule.o
$(aPe)/ww3_shel : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_shel : $(aPo)/yowpd.o
...
$(aPe)/ww3_shel : $(aPo)/yowfunction.o
$(aPe)/ww3_shel : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_shel : $(aPo)/w3profsmd_pdlib.o
...
$(aPe)/ww3_shel : $(aPo)/ww3_shel.o
	@$(aPb)/link ww3_shel wmmdatmd  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd w3fldsmd w3initmd w3wavemd w3wdasmd w3updtmd w3profsmd w3pro3md w3uqckmd yowfunction pdlib_field_vec w3profsmd_pdlib  w3triamd w3srcemd  w3flx1md w3sln1md w3src4md w3snl1md w3sbt1md   w3sdb1md w3str1md   w3ref1md  w3parall  w3iogrmd w3iogomd w3iopomd w3iotrmd w3iorsmd w3iobcmd     w3iosfmd w3partmd constants w3servmd w3timemd  w3arrymd w3dispmd w3cspcmd w3gsrumd  w3nmlshelmd yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd
...
$(aPe)/ww3_multi : $(aPo)/yowfunction.o
$(aPe)/ww3_multi : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_multi : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_multi : $(aPo)/yowsidepool.o
$(aPe)/ww3_multi : $(aPo)/yowdatapool.o
$(aPe)/ww3_multi : $(aPo)/yowerr.o
$(aPe)/ww3_multi : $(aPo)/yownodepool.o
$(aPe)/ww3_multi : $(aPo)/yowelementpool.o
$(aPe)/ww3_multi : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_multi : $(aPo)/yowrankModule.o
$(aPe)/ww3_multi : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_multi : $(aPo)/yowpd.o
...
$(aPe)/ww3_multi : $(aPo)/ww3_multi.o
	@$(aPb)/link ww3_multi wmmdatmd  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd  wminitmd wmwavemd wmfinlmd wmgridmd wmupdtmd wminiomd w3fldsmd w3initmd w3wavemd w3wdasmd w3updtmd w3profsmd w3pro3md w3uqckmd yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd  w3parall w3triamd w3srcemd  w3flx1md w3sln1md w3src4md w3snl1md w3sbt1md   w3sdb1md w3str1md   w3ref1md   w3iogrmd w3iogomd w3iopomd wmiopomd w3iotrmd w3iorsmd w3iobcmd w3iosfmd w3partmd     constants  w3servmd w3timemd w3arrymd w3dispmd w3cspcmd w3gsrumd   wmunitmd w3nmlmultimd
...
$(aPe)/ww3_sbs1 : $(aPo)/yowfunction.o
$(aPe)/ww3_sbs1 : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_sbs1 : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_sbs1 : $(aPo)/yowsidepool.o
$(aPe)/ww3_sbs1 : $(aPo)/yowdatapool.o
$(aPe)/ww3_sbs1 : $(aPo)/yowerr.o
$(aPe)/ww3_sbs1 : $(aPo)/yownodepool.o
$(aPe)/ww3_sbs1 : $(aPo)/yowelementpool.o
$(aPe)/ww3_sbs1 : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_sbs1 : $(aPo)/yowrankModule.o
$(aPe)/ww3_sbs1 : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_sbs1 : $(aPo)/yowpd.o
...
$(aPe)/ww3_outf : $(aPo)/yowfunction.o
$(aPe)/ww3_outf : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_outf : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_outf : $(aPo)/yowsidepool.o
$(aPe)/ww3_outf : $(aPo)/yowdatapool.o
$(aPe)/ww3_outf : $(aPo)/yowerr.o
$(aPe)/ww3_outf : $(aPo)/yownodepool.o
$(aPe)/ww3_outf : $(aPo)/yowelementpool.o
$(aPe)/ww3_outf : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_outf : $(aPo)/yowrankModule.o
$(aPe)/ww3_outf : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_outf : $(aPo)/yowpd.o
...
$(aPe)/ww3_outf : $(aPo)/ww3_outf.o
	@$(aPb)/link ww3_outf w3parall wmmdatmd  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  w3str1md  w3src4md w3snl1md    w3iogrmd w3iogomd constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd
...
$(aPe)/ww3_outp : $(aPo)/yowfunction.o
$(aPe)/ww3_outp : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_outp : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_outp : $(aPo)/yowsidepool.o
$(aPe)/ww3_outp : $(aPo)/yowdatapool.o
$(aPe)/ww3_outp : $(aPo)/yowerr.o
$(aPe)/ww3_outp : $(aPo)/yownodepool.o
$(aPe)/ww3_outp : $(aPo)/yowelementpool.o
$(aPe)/ww3_outp : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_outp : $(aPo)/yowrankModule.o
$(aPe)/ww3_outp : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_outp : $(aPo)/yowpd.o
...
$(aPe)/ww3_outp : $(aPo)/ww3_outp.o
	@$(aPb)/link ww3_outp wmmdatmd w3parall w3triamd  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd  w3flx1md w3sln1md w3src4md w3snl1md w3sbt1md   w3sdb1md w3str1md     w3bullmd w3iogrmd w3iopomd w3partmd constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd
...
$(aPe)/ww3_grib : $(aPo)/yowfunction.o
$(aPe)/ww3_grib : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_grib : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_grib : $(aPo)/yowsidepool.o
$(aPe)/ww3_grib : $(aPo)/yowdatapool.o
$(aPe)/ww3_grib : $(aPo)/yowerr.o
$(aPe)/ww3_grib : $(aPo)/yownodepool.o
$(aPe)/ww3_grib : $(aPo)/yowelementpool.o
$(aPe)/ww3_grib : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_grib : $(aPo)/yowrankModule.o
$(aPe)/ww3_grib : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_grib : $(aPo)/yowpd.o
...
$(aPe)/ww3_grib : $(aPo)/ww3_grib.o
	@$(aPb)/link ww3_grib w3parall wmmdatmd w3triamd  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  w3src4md w3snl1md    w3iogrmd w3iogomd constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd
...
$(aPe)/gx_outf : $(aPo)/yowfunction.o
$(aPe)/gx_outf : $(aPo)/pdlib_field_vec.o
$(aPe)/gx_outf : $(aPo)/w3profsmd_pdlib.o
$(aPe)/gx_outf : $(aPo)/yowsidepool.o
$(aPe)/gx_outf : $(aPo)/yowdatapool.o
$(aPe)/gx_outf : $(aPo)/yowerr.o
$(aPe)/gx_outf : $(aPo)/yownodepool.o
$(aPe)/gx_outf : $(aPo)/yowelementpool.o
$(aPe)/gx_outf : $(aPo)/yowexchangeModule.o
$(aPe)/gx_outf : $(aPo)/yowrankModule.o
$(aPe)/gx_outf : $(aPo)/yowpdlibmain.o
$(aPe)/gx_outf : $(aPo)/yowpd.o
...
$(aPe)/gx_outf : $(aPo)/gx_outf.o
	@$(aPb)/link gx_outf  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  wmmdatmd w3parall w3triamd w3src4md w3snl1md  w3str1md     w3iogrmd w3iogomd constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd
...
$(aPe)/gx_outp : $(aPo)/yowfunction.o
$(aPe)/gx_outp : $(aPo)/pdlib_field_vec.o
$(aPe)/gx_outp : $(aPo)/w3profsmd_pdlib.o
$(aPe)/gx_outp : $(aPo)/yowsidepool.o
$(aPe)/gx_outp : $(aPo)/yowdatapool.o
$(aPe)/gx_outp : $(aPo)/yowerr.o
$(aPe)/gx_outp : $(aPo)/yownodepool.o
$(aPe)/gx_outp : $(aPo)/yowelementpool.o
$(aPe)/gx_outp : $(aPo)/yowexchangeModule.o
$(aPe)/gx_outp : $(aPo)/yowrankModule.o
$(aPe)/gx_outp : $(aPo)/yowpdlibmain.o
$(aPe)/gx_outp : $(aPo)/yowpd.o
...
$(aPe)/gx_outp : $(aPo)/gx_outp.o
	@$(aPb)/link gx_outp  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  wmmdatmd w3parall w3triamd w3sln1md w3flx1md w3src4md w3snl1md  w3str1md      w3iogrmd w3iopomd constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd
...
$(aPe)/ww3_ounf : $(aPo)/yowfunction.o
$(aPe)/ww3_ounf : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_ounf : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_ounf : $(aPo)/yowsidepool.o
$(aPe)/ww3_ounf : $(aPo)/yowdatapool.o
$(aPe)/ww3_ounf : $(aPo)/yowerr.o
$(aPe)/ww3_ounf : $(aPo)/yownodepool.o
$(aPe)/ww3_ounf : $(aPo)/yowelementpool.o
$(aPe)/ww3_ounf : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_ounf : $(aPo)/yowrankModule.o
$(aPe)/ww3_ounf : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_ounf : $(aPo)/yowpd.o
...
$(aPe)/ww3_ounf : $(aPo)/ww3_ounf.o
	@$(aPb)/link ww3_ounf wmmdatmd  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd w3initmd  yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  w3parall w3triamd w3src4md w3snl1md     w3iogrmd w3iogomd w3iorsmd w3iopomd constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd w3nmlounfmd 
...
$(aPe)/ww3_ounp : $(aPo)/yowfunction.o
$(aPe)/ww3_ounp : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_ounp : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_ounp : $(aPo)/yowsidepool.o
$(aPe)/ww3_ounp : $(aPo)/yowdatapool.o
$(aPe)/ww3_ounp : $(aPo)/yowerr.o
$(aPe)/ww3_ounp : $(aPo)/yownodepool.o
$(aPe)/ww3_ounp : $(aPo)/yowelementpool.o
$(aPe)/ww3_ounp : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_ounp : $(aPo)/yowrankModule.o
$(aPe)/ww3_ounp : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_ounp : $(aPo)/yowpd.o
...
$(aPe)/ww3_ounp : $(aPo)/ww3_ounp.o
	@$(aPb)/link ww3_ounp wmmdatmd w3parall w3triamd  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd  w3flx1md w3sln1md w3src4md w3snl1md w3sbt1md   w3sdb1md w3str1md     w3bullmd w3iogrmd w3iopomd w3partmd constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd w3nmlounpmd
...
$(aPe)/ww3_gspl : $(aPo)/yowfunction.o
$(aPe)/ww3_gspl : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_gspl : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_gspl : $(aPo)/yowsidepool.o
$(aPe)/ww3_gspl : $(aPo)/yowdatapool.o
$(aPe)/ww3_gspl : $(aPo)/yowerr.o
$(aPe)/ww3_gspl : $(aPo)/yownodepool.o
$(aPe)/ww3_gspl : $(aPo)/yowelementpool.o
$(aPe)/ww3_gspl : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_gspl : $(aPo)/yowrankModule.o
$(aPe)/ww3_gspl : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_gspl : $(aPo)/yowpd.o
...
$(aPe)/ww3_gspl : $(aPo)/ww3_gspl.o
	@$(aPb)/link ww3_gspl  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd w3fldsmd  yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  wmmdatmd w3parall w3triamd w3src4md w3snl1md    w3iogrmd      constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd 
...
$(aPe)/ww3_gint : $(aPo)/yowfunction.o
$(aPe)/ww3_gint : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_gint : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_gint : $(aPo)/yowsidepool.o
$(aPe)/ww3_gint : $(aPo)/yowdatapool.o
$(aPe)/ww3_gint : $(aPo)/yowerr.o
$(aPe)/ww3_gint : $(aPo)/yownodepool.o
$(aPe)/ww3_gint : $(aPo)/yowelementpool.o
$(aPe)/ww3_gint : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_gint : $(aPo)/yowrankModule.o
$(aPe)/ww3_gint : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_gint : $(aPo)/yowpd.o
...
$(aPe)/ww3_gint : $(aPo)/ww3_gint.o
	@$(aPb)/link ww3_gint w3parall wmmdatmd  w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md w3src4md w3snl1md   w3iogrmd w3iogomd constants w3triamd w3servmd  w3arrymd w3dispmd w3timemd w3gsrumd
...
$(aPe)/ww3_bound : $(aPo)/yowfunction.o
$(aPe)/ww3_bound : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_bound : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_bound : $(aPo)/yowsidepool.o
$(aPe)/ww3_bound : $(aPo)/yowdatapool.o
$(aPe)/ww3_bound : $(aPo)/yowerr.o
$(aPe)/ww3_bound : $(aPo)/yownodepool.o
$(aPe)/ww3_bound : $(aPo)/yowelementpool.o
$(aPe)/ww3_bound : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_bound : $(aPo)/yowrankModule.o
$(aPe)/ww3_bound : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_bound : $(aPo)/yowpd.o
...
$(aPe)/ww3_bound : $(aPo)/ww3_bound.o
	@$(aPb)/link ww3_bound w3adatmd  w3gdatmd w3wdatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  w3str1md  w3src4md w3snl1md   wmmdatmd w3parall w3triamd  w3iobcmd w3iogrmd w3dispmd w3gsrumd constants w3servmd w3timemd w3arrymd w3cspcmd
...
$(aPe)/ww3_bounc : $(aPo)/yowfunction.o
$(aPe)/ww3_bounc : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_bounc : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_bounc : $(aPo)/yowsidepool.o
$(aPe)/ww3_bounc : $(aPo)/yowdatapool.o
$(aPe)/ww3_bounc : $(aPo)/yowerr.o
$(aPe)/ww3_bounc : $(aPo)/yownodepool.o
$(aPe)/ww3_bounc : $(aPo)/yowelementpool.o
$(aPe)/ww3_bounc : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_bounc : $(aPo)/yowrankModule.o
$(aPe)/ww3_bounc : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_bounc : $(aPo)/yowpd.o
...
$(aPe)/ww3_bounc : $(aPo)/ww3_bounc.o
	@$(aPb)/link ww3_bounc w3adatmd  w3gdatmd w3wdatmd w3idatmd w3odatmd   yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  w3src4md w3snl1md   wmmdatmd w3parall w3triamd  w3iobcmd w3iogrmd w3dispmd w3gsrumd constants w3servmd w3arrymd w3timemd w3cspcmd w3nmlbouncmd
...
$(aPe)/ww3_systrk : $(aPo)/yowfunction.o
$(aPe)/ww3_systrk : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_systrk : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_systrk : $(aPo)/yowsidepool.o
$(aPe)/ww3_systrk : $(aPo)/yowdatapool.o
$(aPe)/ww3_systrk : $(aPo)/yowerr.o
$(aPe)/ww3_systrk : $(aPo)/yownodepool.o
$(aPe)/ww3_systrk : $(aPo)/yowelementpool.o
$(aPe)/ww3_systrk : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_systrk : $(aPo)/yowrankModule.o
$(aPe)/ww3_systrk : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_systrk : $(aPo)/yowpd.o
...
$(aPe)/ww3_systrk : $(aPo)/ww3_systrk.o
	@$(aPb)/link ww3_systrk  w3gdatmd w3adatmd w3idatmd w3odatmd w3wdatmd w3strkmd  yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3sdb1md w3sbt1md  wmmdatmd w3dispmd w3triamd w3sln1md w3src4md w3snl1md  w3str1md      constants w3servmd w3timemd w3arrymd w3gsrumd w3parall
...
ww3_multi_esmf : $(aPo)/yowfunction.o
ww3_multi_esmf : $(aPo)/pdlib_field_vec.o
ww3_multi_esmf : $(aPo)/w3profsmd_pdlib.o
ww3_multi_esmf : $(aPo)/yowsidepool.o
ww3_multi_esmf : $(aPo)/yowdatapool.o
ww3_multi_esmf : $(aPo)/yowerr.o
ww3_multi_esmf : $(aPo)/yownodepool.o
ww3_multi_esmf : $(aPo)/yowelementpool.o
ww3_multi_esmf : $(aPo)/yowexchangeModule.o
ww3_multi_esmf : $(aPo)/yowrankModule.o
ww3_multi_esmf : $(aPo)/yowpdlibmain.o
ww3_multi_esmf : $(aPo)/yowpd.o
...
ww3_multi_esmf : $(aPo)/w3partmd.o
	@cd $(aPo); ar rv libww3_multi_esmf.a  wmmdatmd.o w3gdatmd.o w3wdatmd.o w3adatmd.o w3idatmd.o w3odatmd.o wmesmfmd.o wminitmd.o wmwavemd.o wmfinlmd.o wmgridmd.o wmupdtmd.o wminiomd.o w3fldsmd.o w3initmd.o w3wavemd.o w3wdasmd.o w3updtmd.o w3profsmd.o w3pro3md.o w3uqckmd.o yowfunction.o pdlib_field_vec.o w3profsmd_pdlib.o yowsidepool.o yowdatapool.o yowerr.o yownodepool.o yowelementpool.o yowexchangeModule.o yowrankModule.o yowpdlibmain.o yowpd.o w3parall.o w3triamd.o w3srcemd.o w3flx1md.o w3sln1md.o w3src4md.o w3snl1md.o w3sbt1md.o w3sdb1md.o w3str1md.o w3ref1md.o w3iogrmd.o w3iogomd.o w3iopomd.o wmiopomd.o w3iotrmd.o w3iorsmd.o w3iobcmd.o w3iosfmd.o w3partmd.o constants.o w3servmd.o w3timemd.o w3arrymd.o w3dispmd.o w3cspcmd.o w3gsrumd.o wmunitmd.o w3nmlmultimd.o
...
$(aPe)/ww3_uprstr : $(aPo)/yowfunction.o
$(aPe)/ww3_uprstr : $(aPo)/pdlib_field_vec.o
$(aPe)/ww3_uprstr : $(aPo)/w3profsmd_pdlib.o
$(aPe)/ww3_uprstr : $(aPo)/yowsidepool.o
$(aPe)/ww3_uprstr : $(aPo)/yowdatapool.o
$(aPe)/ww3_uprstr : $(aPo)/yowerr.o
$(aPe)/ww3_uprstr : $(aPo)/yownodepool.o
$(aPe)/ww3_uprstr : $(aPo)/yowelementpool.o
$(aPe)/ww3_uprstr : $(aPo)/yowexchangeModule.o
$(aPe)/ww3_uprstr : $(aPo)/yowrankModule.o
$(aPe)/ww3_uprstr : $(aPo)/yowpdlibmain.o
$(aPe)/ww3_uprstr : $(aPo)/yowpd.o
...
$(aPe)/ww3_uprstr : $(aPo)/ww3_uprstr.o
	@$(aPb)/link ww3_uprstr wmmdatmd w3triamd w3gdatmd w3wdatmd w3adatmd w3idatmd w3odatmd    yowfunction pdlib_field_vec w3profsmd_pdlib yowsidepool yowdatapool yowerr yownodepool yowelementpool yowexchangeModule yowrankModule yowpdlibmain yowpd w3flx1md w3sln1md w3src4md w3snl1md w3sbt1md   w3sdb1md w3str1md    w3iogrmd w3iogomd w3iorsmd constants w3servmd w3timemd w3arrymd w3dispmd w3gsrumd w3parall
...
libww3 : $(aPo)/w3partmd.o
	@cd $(aPo); ar rv libww3.a  wmmdatmd.o w3gdatmd.o w3wdatmd.o w3adatmd.o w3idatmd.o w3odatmd.o w3fldsmd.o w3initmd.o w3wavemd.o w3wdasmd.o w3updtmd.o w3profsmd.o w3pro3md.o w3uqckmd.o w3triamd.o w3srcemd.o w3flx1md.o w3sln1md.o w3src4md.o w3snl1md.o w3sbt1md.o w3sdb1md.o w3str1md.o w3ref1md.o w3iogrmd.o w3iogomd.o w3iopomd.o w3iotrmd.o w3iorsmd.o w3iobcmd.o w3iosfmd.o w3partmd.o constants.o w3servmd.o w3timemd.o w3arrymd.o w3dispmd.o w3cspcmd.o w3gsrumd.o
...
$(aPo)/pdlib_field_vec.o : pdlib_field_vec.ftn w3macros.h  $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3odatmd.o $(aPo)/w3parall.o $(aPo)/w3servmd.o $(aPo)/w3wdatmd.o $(aPo)/yowdatapool.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 pdlib_field_vec
...
$(aPo)/w3initmd.o : w3initmd.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3profsmd_pdlib.o $(aPo)/w3adatmd.o $(aPo)/w3arrymd.o $(aPo)/w3dispmd.o $(aPo)/w3gdatmd.o $(aPo)/w3idatmd.o $(aPo)/w3iogomd.o $(aPo)/w3iogrmd.o $(aPo)/w3iopomd.o $(aPo)/w3iorsmd.o $(aPo)/w3odatmd.o $(aPo)/w3parall.o $(aPo)/w3servmd.o $(aPo)/w3timemd.o $(aPo)/w3wdatmd.o $(aPo)/yowdatapool.o $(aPo)/yownodepool.o $(aPo)/yowrankModule.o
	@$(aPb)/ad3 w3initmd
...
$(aPo)/w3iorsmd.o : w3iorsmd.ftn w3macros.h  $(aPo)/constants.o $(aPo)/pdlib_field_vec.o $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3odatmd.o $(aPo)/w3parall.o $(aPo)/w3servmd.o $(aPo)/w3triamd.o $(aPo)/w3wdatmd.o
	@$(aPb)/ad3 w3iorsmd
...
$(aPo)/w3parall.o : w3parall.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3idatmd.o $(aPo)/w3odatmd.o $(aPo)/wmmdatmd.o $(aPo)/yowdatapool.o $(aPo)/yownodepool.o $(aPo)/yowrankModule.o
	@$(aPb)/ad3 w3parall
...
$(aPo)/w3profsmd_pdlib.o : w3profsmd_pdlib.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3idatmd.o $(aPo)/w3odatmd.o $(aPo)/w3parall.o $(aPo)/w3sbt1md.o $(aPo)/w3sdb1md.o $(aPo)/w3str1md.o $(aPo)/w3timemd.o $(aPo)/w3wdatmd.o $(aPo)/yowdatapool.o $(aPo)/yowelementpool.o $(aPo)/yowexchangeModule.o $(aPo)/yowfunction.o $(aPo)/yownodepool.o $(aPo)/yowpdlibmain.o $(aPo)/yowrankModule.o
	@$(aPb)/ad3 w3profsmd_pdlib
 
$(aPo)/w3ref1md.o : w3ref1md.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3gdatmd.o
	@$(aPb)/ad3 w3ref1md
...
$(aPo)/w3srcemd.o : w3srcemd.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3profsmd_pdlib.o $(aPo)/w3dispmd.o $(aPo)/w3gdatmd.o $(aPo)/w3idatmd.o $(aPo)/w3odatmd.o $(aPo)/w3parall.o $(aPo)/w3ref1md.o $(aPo)/w3sbt1md.o $(aPo)/w3sdb1md.o $(aPo)/w3sln1md.o $(aPo)/w3snl1md.o $(aPo)/w3src4md.o $(aPo)/w3str1md.o $(aPo)/w3wdatmd.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 w3srcemd
...
$(aPo)/w3triamd.o : w3triamd.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3idatmd.o $(aPo)/w3odatmd.o $(aPo)/w3servmd.o $(aPo)/yowelementpool.o $(aPo)/yowexchangeModule.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 w3triamd
...
$(aPo)/w3wavemd.o : w3wavemd.ftn w3macros.h  $(aPo)/constants.o $(aPo)/pdlib_field_vec.o $(aPo)/w3profsmd_pdlib.o $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3idatmd.o $(aPo)/w3iobcmd.o $(aPo)/w3iogomd.o $(aPo)/w3iogrmd.o $(aPo)/w3iopomd.o $(aPo)/w3iorsmd.o $(aPo)/w3iosfmd.o $(aPo)/w3iotrmd.o $(aPo)/w3odatmd.o $(aPo)/w3parall.o $(aPo)/w3pro3md.o $(aPo)/w3profsmd.o $(aPo)/w3servmd.o $(aPo)/w3srcemd.o $(aPo)/w3timemd.o $(aPo)/w3triamd.o $(aPo)/w3updtmd.o $(aPo)/w3wdatmd.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 w3wavemd
 
$(aPo)/w3wdasmd.o : w3wdasmd.ftn w3macros.h  $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3odatmd.o $(aPo)/w3wdatmd.o
	@$(aPb)/ad3 w3wdasmd
 
$(aPo)/w3wdatmd.o : w3wdatmd.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3gdatmd.o $(aPo)/w3odatmd.o $(aPo)/w3parall.o $(aPo)/w3servmd.o $(aPo)/yownodepool.o $(aPo)/yowrankModule.o
	@$(aPb)/ad3 w3wdatmd
 
$(aPo)/wmesmfmd.o : wmesmfmd.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3idatmd.o $(aPo)/w3iogomd.o $(aPo)/w3odatmd.o $(aPo)/w3src4md.o $(aPo)/w3timemd.o $(aPo)/w3updtmd.o $(aPo)/w3wdatmd.o $(aPo)/wmfinlmd.o $(aPo)/wminitmd.o $(aPo)/wmmdatmd.o $(aPo)/wmupdtmd.o $(aPo)/wmwavemd.o $(aPo)/yowelementpool.o $(aPo)/yownodepool.o $(aPo)/yowrankModule.o
	@$(aPb)/ad3 wmesmfmd
...
$(aPo)/wminiomd.o : wminiomd.ftn w3macros.h  $(aPo)/w3adatmd.o $(aPo)/w3cspcmd.o $(aPo)/w3gdatmd.o $(aPo)/w3iobcmd.o $(aPo)/w3odatmd.o $(aPo)/w3parall.o $(aPo)/w3servmd.o $(aPo)/w3timemd.o $(aPo)/w3updtmd.o $(aPo)/w3wdatmd.o $(aPo)/wmmdatmd.o $(aPo)/yowexchangeModule.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 wminiomd
...
$(aPo)/ww3_shel.o : ww3_shel.ftn w3macros.h  $(aPo)/constants.o $(aPo)/w3adatmd.o $(aPo)/w3fldsmd.o $(aPo)/w3gdatmd.o $(aPo)/w3idatmd.o $(aPo)/w3initmd.o $(aPo)/w3iogomd.o $(aPo)/w3iogrmd.o $(aPo)/w3iopomd.o $(aPo)/w3nmlshelmd.o $(aPo)/w3odatmd.o $(aPo)/w3servmd.o $(aPo)/w3timemd.o $(aPo)/w3wavemd.o $(aPo)/w3wdasmd.o $(aPo)/w3wdatmd.o
	@$(aPb)/ad3 ww3_shel
...
$(aPo)/yowdatapool.o : PDLIB/yowdatapool.ftn 
	@$(aPb)/ad3 yowdatapool
 
$(aPo)/yowelementpool.o : PDLIB/yowelementpool.ftn  $(aPo)/yowdatapool.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 yowelementpool
 
$(aPo)/yowerr.o : PDLIB/yowerr.ftn  $(aPo)/yowdatapool.o
	@$(aPb)/ad3 yowerr
 
$(aPo)/yowexchangeModule.o : PDLIB/yowexchangeModule.ftn  $(aPo)/w3odatmd.o $(aPo)/yowdatapool.o $(aPo)/yowerr.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 yowexchangeModule
 
$(aPo)/yowfunction.o : PDLIB/yowfunction.ftn  $(aPo)/w3adatmd.o $(aPo)/w3gdatmd.o $(aPo)/w3odatmd.o $(aPo)/yowdatapool.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 yowfunction
 
$(aPo)/yownodepool.o : PDLIB/yownodepool.ftn  $(aPo)/yowdatapool.o
	@$(aPb)/ad3 yownodepool
 
$(aPo)/yowpd.o : PDLIB/yowpd.ftn  $(aPo)/yowdatapool.o $(aPo)/yowelementpool.o $(aPo)/yowerr.o $(aPo)/yowexchangeModule.o $(aPo)/yownodepool.o $(aPo)/yowpdlibmain.o $(aPo)/yowrankModule.o $(aPo)/yowsidepool.o
	@$(aPb)/ad3 yowpd
 
$(aPo)/yowpdlibmain.o : PDLIB/yowpdlibmain.ftn  $(aPo)/yowdatapool.o $(aPo)/yowelementpool.o $(aPo)/yowerr.o $(aPo)/yowexchangeModule.o $(aPo)/yownodepool.o $(aPo)/yowrankModule.o $(aPo)/yowsidepool.o
	@$(aPb)/ad3 yowpdlibmain
 
$(aPo)/yowrankModule.o : PDLIB/yowrankModule.ftn  $(aPo)/yowdatapool.o $(aPo)/yowerr.o $(aPo)/yownodepool.o
	@$(aPb)/ad3 yowrankModule
 
$(aPo)/yowsidepool.o : PDLIB/yowsidepool.ftn 
	@$(aPb)/ad3 yowsidepool
